export function getMainDom() {
  ...
  const buttons = {
    ...
    btnPolarDay: document.getElementById('btnPolarDay'),
    ...
    btnPresetVerticalGradient: document.getElementById('btnPresetVerticalGradient'),
    ...
    btnViewTransfer: document.getElementById('btnViewTransfer'),
